...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseCountry"
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-toggle="collapse" data-target="#collapseEpisode"
               aria-expanded="true" aria-controls="collapseEpisode">
                <i class="fas fa-fw fa-wrench"></i>
                <span>Tập phim</span>
            </a>
            <div id="collapseEpisode" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{ route('admin.episodes.index') }}">Danh sách</a>
                    <a class="collapse-item" href="{{ route('admin.episodes.create') }}">Thêm mới</a>
                </div>
            </div>
        </li>
