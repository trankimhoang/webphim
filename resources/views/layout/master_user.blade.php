...
<head>
    ...
    <link rel='stylesheet' id='bootstrap-css' href='{{ asset('theme/web/css/bootstrap.min.css?ver=5.7.2') }}' media='all' />
    <link rel='stylesheet' id='style-css' href='{{ asset('theme/web/css/style.css?ver=5.7.2') }}' media='all' />
    <link rel='stylesheet' id='wp-block-library-css' href='{{ asset('theme/web/css/style.min.css?ver=5.7.2') }}' media='all' />
    <script type='text/javascript' src='{{ asset('theme/web/js/jquery.min.js?ver=5.7.2') }}' id='halim-jquery-js'></script>
                ...
                <div class="menu-menu_1-container">
                    <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                        ...
                        <li class="mega dropdown">
                            <a title="Thể Loại" href="#" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">Danh mục <span class="caret"></span></a>
                            <ul role="menu" class=" dropdown-menu">
                                @foreach($listCategory as $category)
                                    <li><a title="Tâm Lý" href="danhmuc.html">{{ $category->title }}</a></li>
                                @endforeach
                            </ul>
                        </li>
                        <li class="mega dropdown">
                            ...
                            <ul role="menu" class=" dropdown-menu">
                                ...
                                <li><a title="Tâm Lý" href="danhmuc.html">{{ $genre->title }}</a></li>
                                @endforeach
                            </ul>
                        </li>
                        <li class="mega dropdown">
                            ...
                            <ul role="menu" class=" dropdown-menu">
                                ...
                                <li><a title="Việt nam" href="danhmuc.html">{{ $country->title }}</a></li>
                                @endforeach
                            </ul>
                        </li>
                    </ul>
...
<script type='text/javascript' src='{{ asset('theme/web/js/bootstrap.min.js?ver=5.7.2') }}' id='bootstrap-js'></script>
<script type='text/javascript' src='{{ asset('theme/web/js/owl.carousel.min.js?ver=5.7.2') }}' id='carousel-js'></script>

<script type='text/javascript' src='{{ asset('theme/web/js/halimtheme-core.min.js?ver=1626273138') }}' id='halim-init-js'></script>
